<?php /* Smarty version Smarty-3.1.8, created on 2012-06-22 13:22:34
         compiled from "/web/presta/admin75149/themes/default/template/controllers/modules/filters.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12532488784fe4557a4bff12-63785714%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05f810276b24d3d944cdb367552844344f9a1bf1' => 
    array (
      0 => '/web/presta/admin75149/themes/default/template/controllers/modules/filters.tpl',
      1 => 1338371678,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12532488784fe4557a4bff12-63785714',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fe4557a5e4689_61201711',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fe4557a5e4689_61201711')) {function content_4fe4557a5e4689_61201711($_smarty_tpl) {?>
...
:</label>
					...
					<select name="module_type" id="module_type_filter" <?php if ($_smarty_tpl->tpl_vars['showTypeModules']->value!='allModules'&&$_smarty_tpl->tpl_vars['showTypeModules']->value!=''){?>style="background-color:#49B2FF;color:white;"<?php }?>>
						...
						<option value="nativeModules" <?php if ($_smarty_tpl->tpl_vars['showTypeModules']->value=='nativeModules'){?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Native Modules'),$_smarty_tpl);?>
</option>
						<option value="partnerModules" <?php if ($_smarty_tpl->tpl_vars['showTypeModules']->value=='partnerModules'){?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Partner Modules'),$_smarty_tpl);?>
</option>
