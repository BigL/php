<?php /* Smarty version Smarty-3.1.8, created on 2012-06-26 23:23:48
         compiled from "/web/presta/admin75149/themes/default/template/controllers/products/prices.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1096841124fea2864582938-48355656%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11b231fefbafccd8ad927d78bea0643fe31b0039' => 
    array (
      0 => '/web/presta/admin75149/themes/default/template/controllers/products/prices.tpl',
      1 => 1339057794,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1096841124fea2864582938-48355656',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fea28648f12b3_33650424',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fea28648f12b3_33650424')) {function content_4fea28648f12b3_33650424($_smarty_tpl) {?>
...
<input size="11" maxlength="14" name="wholesale_price" id="wholesale_price" type="text" value="<?php echo sprintf('%.2f',$_smarty_tpl->tpl_vars['product']->value->wholesale_price);?>
" onchange="this.value = this.value.replace(/,/g, '.');" /><?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
	...
	<tr>
		...
		<td style="padding-bottom:5px;">
			<input type="hidden"  id="priceTEReal" name="price" value="<?php echo $_smarty_tpl->tpl_vars['product']->value->price;?>
" />
			<?php echo $_smarty_tpl->tpl_vars['currency']->value->prefix;?>
<input size="11" maxlength="14" id="priceTE" name="price_displayed" type="text" value="<?php echo sprintf('%.2f',$_smarty_tpl->tpl_vars['product']->value->price);?>
...
" <?php if ($_smarty_tpl->tpl_vars['product']->value->getIdTaxRulesGroup()==$_smarty_tpl->tpl_vars['tax_rules_group']->value['id_tax_rules_group']){?>selected="selected"<?php }?> >
				...
				<a class="button" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminTaxRulesGroup');?>
...
</span> (<b><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminTaxes');?>
	...
	<table style="text-align: center;width:100%" class="table" cellpadding="0" cellspacing="0" id="specific_prices_list">
		<thead>
			<tr>
				...
				<th class="cell border" style="width: 12%;"><?php echo smartyTranslate(array('s'=>'Price'),$_smarty_tpl);?>
 <?php if ($_smarty_tpl->tpl_vars['country_display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'(tax excl.)'),$_smarty_tpl);?>
<?php }?></th>
				<th class="cell border" style="width: 10%;"><?php echo smartyTranslate(array('s'=>'Reduction'),$_smarty_tpl);?>
</th>
				<th class="cell border" style="width: 15%;"><?php echo smartyTranslate(array('s'=>'Period'),$_smarty_tpl);?>
</th>
				<th class="cell border" style="width: 10%;"><?php echo smartyTranslate(array('s'=>'From (quantity)'),$_smarty_tpl);?>
</th>
				<th class="cell border" style="width: 15%;"><?php echo smartyTranslate(array('s'=>'Final price'),$_smarty_tpl);?>
 <?php if ($_smarty_tpl->tpl_vars['country_display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'(tax excl.)'),$_smarty_tpl);?>
<?php }?></th>
