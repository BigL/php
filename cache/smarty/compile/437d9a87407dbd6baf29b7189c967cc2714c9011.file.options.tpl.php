<?php /* Smarty version Smarty-3.1.8, created on 2012-06-25 16:59:38
         compiled from "/web/presta/admin75149/themes/default/template/controllers/meta/helpers/options/options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20763101924fe87cda27f4c1-89955826%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '437d9a87407dbd6baf29b7189c967cc2714c9011' => 
    array (
      0 => '/web/presta/admin75149/themes/default/template/controllers/meta/helpers/options/options.tpl',
      1 => 1338562704,
      2 => 'file',
    ),
    '8ef6b239f6e29b95ac82fb0dc747dfd46222731d' => 
    array (
      0 => '/web/presta/admin75149/themes/default/template/helpers/options/options.tpl',
      1 => 1338796160,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20763101924fe87cda27f4c1-89955826',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fe87cda836a34_60174546',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fe87cda836a34_60174546')) {function content_4fe87cda836a34_60174546($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/web/presta/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_replace')) include '/web/presta/tools/smarty/plugins/modifier.replace.php';
?>
...
_off"> <?php echo smartyTranslate(array('s'=>'No'),$_smarty_tpl);?>
		...
		<?php if (!$_smarty_tpl->tpl_vars['field']->value['mod_rewrite']){?>
			<span class="warning_mod_rewrite"><?php echo smartyTranslate(array('s'=>'URL rewriting (mod_rewrite) is not active on your server. If you want to use Friendly URL you must activate this mod.'),$_smarty_tpl);?>
</span>
			<div class="clear"></div>
		<?php }?>
	<?php }else{ ?>
