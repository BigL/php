<?php /* Smarty version Smarty-3.1.8, created on 2012-06-26 18:23:53
         compiled from "/web/presta/themes/default/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:973605354fe9e2195c6dd6-60174064%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8985e0de0c48604bbfe3d26f50bc91089ce0cc86' => 
    array (
      0 => '/web/presta/themes/default/contact-form.tpl',
      1 => 1335191262,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '973605354fe9e2195c6dd6-60174064',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fe9e21981a2c5_57944095',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fe9e21981a2c5_57944095')) {function content_4fe9e21981a2c5_57944095($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/web/presta/tools/smarty/plugins/modifier.escape.php';
?>
...
" class="desc_contact" style="display:none;">
			...
			<p class="text">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['email'])){?>
					<input type="text" id="email" name="from" value="<?php echo $_smarty_tpl->tpl_vars['customerThread']->value['email'];?>
" readonly="readonly" />
				<?php }else{ ?>
					<input type="text" id="email" name="from" value="<?php echo $_smarty_tpl->tpl_vars['email']->value;?>
" />
				<?php }?>
			</p>
