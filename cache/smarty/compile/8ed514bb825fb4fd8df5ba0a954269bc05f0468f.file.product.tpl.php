<?php /* Smarty version Smarty-3.1.8, created on 2012-06-26 23:36:21
         compiled from "/web/presta/themes/default/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17822693454fea2b55624465-30832596%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ed514bb825fb4fd8df5ba0a954269bc05f0468f' => 
    array (
      0 => '/web/presta/themes/default/product.tpl',
      1 => 1337440464,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17822693454fea2b55624465-30832596',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fea2b5647a190_01925473',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fea2b5647a190_01925473')) {function content_4fea2b5647a190_01925473($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/web/presta/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_date_format')) include '/web/presta/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/web/presta/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/web/presta/tools/smarty/plugins/function.counter.php';
?>
...
" class="on_sale_img"/>
			...
			<?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='percentage'){?>
				<p id="reduction_percent"><span id="reduction_percent_display">-<?php echo $_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']*100;?>
%</span></p>
			<?php }elseif($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='amount'&&intval($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])!=0){?>
				<p id="reduction_amount"><span id="reduction_amount_display">-<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])),$_smarty_tpl);?>
</span></p>
			<?php }?>
