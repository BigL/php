<?php /* Smarty version Smarty-3.1.8, created on 2012-06-22 13:22:34
         compiled from "/web/presta/admin75149/themes/default/template/controllers/modules/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11649501474fe4557a5ee9f7-14940370%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9810ceb0e5167c98b59876474f44e19bdc22ef25' => 
    array (
      0 => '/web/presta/admin75149/themes/default/template/controllers/modules/list.tpl',
      1 => 1335971042,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11649501474fe4557a5ee9f7-14940370',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fe4557a741456_40951646',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fe4557a741456_40951646')) {function content_4fe4557a741456_40951646($_smarty_tpl) {?>
...
<?php if (isset($_smarty_tpl->tpl_vars['module']->value->id)&&$_smarty_tpl->tpl_vars['module']->value->id>0){?><span class="setup<?php if (isset($_smarty_tpl->tpl_vars['module']->value->active)&&$_smarty_tpl->tpl_vars['module']->value->active==0){?> off<?php }?>"><?php echo smartyTranslate(array('s'=>'Installed'),$_smarty_tpl);?>
...
" class="button updated"><span><?php echo smartyTranslate(array('s'=>'Update it!'),$_smarty_tpl);?>
									...
									<?php }?>
					      			<li><a <?php if (isset($_smarty_tpl->tpl_vars['module']->value->id)&&$_smarty_tpl->tpl_vars['module']->value->id>0&&!empty($_smarty_tpl->tpl_vars['module']->value->options['uninstall_onclick'])){?>onclick="<?php echo $_smarty_tpl->tpl_vars['module']->value->options['uninstall_onclick'];?>
...
<?php }?>" class="button installed"><span><?php if (isset($_smarty_tpl->tpl_vars['module']->value->id)&&$_smarty_tpl->tpl_vars['module']->value->id>0){?><?php echo smartyTranslate(array('s'=>'Uninstall'),$_smarty_tpl);?>
