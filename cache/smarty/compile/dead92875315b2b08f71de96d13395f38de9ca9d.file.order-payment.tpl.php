<?php /* Smarty version Smarty-3.1.8, created on 2012-06-26 23:37:53
         compiled from "/web/presta/themes/default/order-payment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10097167814fea2bb1a12703-48043808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dead92875315b2b08f71de96d13395f38de9ca9d' => 
    array (
      0 => '/web/presta/themes/default/order-payment.tpl',
      1 => 1337608672,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10097167814fea2bb1a12703-48043808',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fea2bb1eff8b8_78174988',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fea2bb1eff8b8_78174988')) {function content_4fea2bb1eff8b8_78174988($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/web/presta/tools/smarty/plugins/modifier.escape.php';
?>
...
?><li><?php if ($_smarty_tpl->tpl_vars['textField']->value['name']){?><?php echo smartyTranslate(array('s'=>'%s:','sprintf'=>$_smarty_tpl->tpl_vars['textField']->value['name']),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Text #%s:','sprintf'=>$_smarty_tpl->getVariable('smarty')->value['foreach']['typedText']['index']+1),$_smarty_tpl);?>
<?php }?> <?php echo $_smarty_tpl->tpl_vars['textField']->value['value'];?>
</li><?php } ?>
									</ul>
								<?php }?>
							<?php } ?>
...
">
				...
				<td class="cart_discount_delete"><a href="<?php if ($_smarty_tpl->tpl_vars['opc']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true);?>
