<?php /* Smarty version Smarty-3.1.8, created on 2012-08-29 17:11:26
         compiled from "/web/presta/admin75149/themes/default/template/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:790928567503e311e49b907-42589103%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e86c424f7c414364e13586f29f13d5f54884b11b' => 
    array (
      0 => '/web/presta/admin75149/themes/default/template/header.tpl',
      1 => 1340659371,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '790928567503e311e49b907-42589103',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_503e311e774cf1_42130295',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_503e311e774cf1_42130295')) {function content_503e311e774cf1_42130295($_smarty_tpl) {?>
...
favicon.ico" />
<?php if ($_smarty_tpl->tpl_vars['display_header']->value){?>
	<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayBackOfficeHeader"),$_smarty_tpl);?>
...
css/admin-ie.css" />
	...
	<style type="text/css">
		...
		color:<?php echo $_smarty_tpl->tpl_vars['brightness']->value;?>

		}
	</style>
</head>
<body style="<?php if ($_smarty_tpl->tpl_vars['bo_color']->value){?>background:<?php echo $_smarty_tpl->tpl_vars['bo_color']->value;?>
;<?php }?><?php if ($_smarty_tpl->tpl_vars['bo_width']->value>0){?>text-align:center;<?php }?>">
<?php if ($_smarty_tpl->tpl_vars['display_header']->value){?>
...
<div id="container">
	...
	<div id="header">
		<div id="header_infos">
			<a id="header_shopname" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminHome');?>
...
"  alt="" /> <?php echo smartyTranslate(array('s'=>'My preferences'),$_smarty_tpl);?>
					...
					<span><?php echo smartyTranslate(array('s'=>'logout'),$_smarty_tpl);?>
</span>
				</a>
					<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
<?php $_tmp3=ob_get_clean();?><?php if ($_tmp3){?>
						<span class="separator"></span> <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
" id="header_foaccess" target="_blank" title="<?php echo smartyTranslate(array('s'=>'View my shop'),$_smarty_tpl);?>
"><span><?php echo smartyTranslate(array('s'=>'View my shop'),$_smarty_tpl);?>
</span></a>
					<?php }?>
			</span>
...
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['quick']->value['link'];?>
<?php if ($_smarty_tpl->tpl_vars['quick']->value['new_window']){?>_blank<?php }?>">&raquo; <?php echo $_smarty_tpl->tpl_vars['quick']->value['name'];?>
			...
			<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayBackOfficeTop"),$_smarty_tpl);?>
...
?>
							<li><a href="<?php echo $_smarty_tpl->tpl_vars['t2']->value['href'];?>
"><?php echo $_smarty_tpl->tpl_vars['t2']->value['name'];?>
</a></li>
						<?php } ?>
					</ul>
				</li>
  ...
  <?php echo smartyTranslate(array('s'=>'delete the /install folder'),$_smarty_tpl);?>
		...
		<?php if ($_smarty_tpl->tpl_vars['display_header']->value&&$_smarty_tpl->tpl_vars['is_multishop']->value&&$_smarty_tpl->tpl_vars['shop_list']->value&&($_smarty_tpl->tpl_vars['multishop_context']->value&Shop::CONTEXT_GROUP||$_smarty_tpl->tpl_vars['multishop_context']->value&Shop::CONTEXT_SHOP)){?>
			<div class="multishop_toolbar">
				<span class="text_multishop"><?php echo smartyTranslate(array('s'=>'Multishop configuration for'),$_smarty_tpl);?>
</span>
